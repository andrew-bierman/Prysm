...
enum AppConfig {
    ...
    /// Privacy policy URL
    static let privacyURL = URL(string: "https://github.com/andrewbierman/Prysm/blob/main/PRIVACY.md")

    /// Terms of service URL
    static let termsURL = URL(string: "https://github.com/andrewbierman/Prysm/blob/main/TERMS.md")
